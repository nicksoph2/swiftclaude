...
final class RuntimeSessionDiscovery: ObservableObject {
    ...
    init(
        claudeRootURL: URL = RealHomeDirectory.url.appendingPathComponent(".claude", isDirectory: true),
...
final class TranscriptScanner: ObservableObject {
    ...
    init(
        ...
        self.fileSystem = fileSystem
        let defaultRoot = RealHomeDirectory.url.appendingPathComponent(".claude", isDirectory: true)
